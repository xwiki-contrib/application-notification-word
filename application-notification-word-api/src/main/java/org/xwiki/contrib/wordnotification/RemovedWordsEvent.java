...
/**
 * Event triggered whenever a queried word is removed from a document.
 ...
 * @version $Id$
 */
public class RemovedWordsEvent implements Event
{
    @Override
    public boolean matches(Object otherEvent)
    {
        return otherEvent instanceof RemovedWordsEvent;
    }
}
